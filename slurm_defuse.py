...
# global variables
load_modules = [
        "load module boost/1.55(default)\n",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sample_file', required=True, type=file,
    ...
    for each_sample in sample_list:
        ...
        "bowtie_threads             = " + args.cpus_per_task + "\n",
        ...
        cmd = slurm_cmd(args.exec_dir, args.sample_dir,
                        args.each_sample, args.output_dir)
        write_sh_files(each_sample, args.ntasks, args.cpus_per_task, args.mem,
